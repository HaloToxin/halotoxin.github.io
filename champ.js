...
function main() {
    ...
    let intervalID  = setInterval((event) => {
        ...
        let o = document.querySelector("div.flex.v2-open.sidebar-v2-location.iy3DiTzRf9NBlWxVqWyi.flex.v2-open.sidebar-v2-location > div:nth-child(2) > header > div.flex.flex-row.justify-start.items-center.topmenu-nav > div");
